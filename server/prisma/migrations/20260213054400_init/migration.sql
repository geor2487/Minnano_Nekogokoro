...
-- CreateIndex
CREATE INDEX "Post_catId_idx" ON "Post"("catId");
...
-- AddForeignKey
ALTER TABLE "Post" ADD CONSTRAINT "Post_catId_fkey" FOREIGN KEY ("catId") REFERENCES "Cat"("id") ON DELETE CASCADE ON UPDATE CASCADE;
